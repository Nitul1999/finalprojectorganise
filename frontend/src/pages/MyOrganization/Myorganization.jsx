    ...
    <>
      <div className="form">
        <form onSubmit={handleSubmit}>
          ...
          <input type="text" name="owner" onChange={(e) => setOwner(e.target.value)} value={owner} required
          />

          <label htmlFor="phone">Phone number:</label>
          <input type="tel"  name="phone" onChange={(e) => setPhone(e.target.value)} value={phone} required
          /> <br />

          <label htmlFor="startdate">Organization From:</label>
          <input type="date" className="officefromdate" name="startdate"  onChange={(e) => setDate(e.target.value)}  value={startdate}
          /> <br />
          ...
          <input  type="number"  name="pin"  onChange={(e) => setPin(e.target.value)}  value={pin}/> <br />

          <label htmlFor="postoffice">Post Office:</label>
          <input  type="text"  name="postoffice"  onChange={(e) => setPostoffice(e.target.value)}  value={postoffice}/>

          <label htmlFor="state">State:</label>
          <input  type="text"  name="state"  onChange={(e) => setMstate(e.target.value)}  value={state}/>
          <label htmlFor="status">Status:</label>
          <select className="status" name="status"  onChange={(e) => setStatus(e.target.value)}  value={status}
          >
          ...
          <div className="services-section">
            ...
            {services.map((service, index) => (
              <div key={index} className="service">
                <input type="text" value={service} onChange={(e) => handleServiceChange(index, e.target.value)}
                />
