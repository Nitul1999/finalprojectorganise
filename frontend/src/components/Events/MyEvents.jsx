      ...
      <div className="card-content">
        ...
        <div>
          <form onSubmit={handleImageUpload}>
            ...
            <input className="imginput" type="file" accept="images/*" onChange={handleFileChange} />
              <button type="submit" className="imagebtn">Upload</button>
          </form>
        </div>
        ...
        {showForm && (
          <div className="form-popup">
            <form onSubmit={handleUpdate}>
              ...
              />
                 <label>Status</label>
                              <select className='selectbtn' onChange={(e) => setstatus(e.target.value === 'true')} value={status}>
               ...
               <label htmlFor="price">Prices</label>
                       <div>
                          ...
                          />
                          <button type="button" className='add-service' onClick={addPrice}>Add Prices</button>
                        </div>
                        <ul>
              ...
              <label htmlFor="capacity">Capacity</label>
                         <div>
                            <input  className ="capacityInput"type="number" placeholder='add capacity' onChange={(e)=>setnewcapacity(e.target.value)} />
